...
function create_cache() {
  ...
  dato=$(date "+%T")
  print '(notification-card :class "notification-card notification-card-'$urgency' notification-card-'$DUNST_APP_NAME'" :SL "'$DUNST_ID'" :L "dunstctl history-pop '$DUNST_ID'" :body ' "'" $body "'"' :summary "'$summary'" :image "'$ICON_PATH'" :application "'$DUNST_APP_NAME \| $dato'")' \
    | cat - "$DUNST_LOG" \
    | sponge "$DUNST_LOG"
}
